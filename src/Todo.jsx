  ...
  return (
    <>
      <div className="min-h-screen bg-black/10 flex flex-col items-center py-10">
        <h1 className="text-4xl font-bold mb-6 font-mono">Personal Todo App</h1>
        ...
        <div className="w-11/12 max-w-[470px] mb-6">
          <div className="flex items-center">
            ...
            />
            <button
              className="px-4 py-2 bg-blue-800 font-semibold text-white rounded-r-md hover:bg-blue-600"
